        ...
        <div className="flex gap-10">
          ...
          <div className="pt-10">
            <div className="w-[247px] h-[230px] bg-[#FDFBEE] rounded-[20px] border-[5px] border-[#A29068] shadow-lg p-4">
              <h2 className="text-[25px] text-[#073A4D] font-['Poppins'] font-extrabold mb-4 text-center">Account Details</h2>
          ...
          <div className="pt-10">
            <div className="w-[676px] h-[615px] bg-[#FDFBEE] rounded-[20px] border-[5px] border-[#A29068] shadow-lg p-8">
              <h2 className="text-[40px] text-[#073A4D] font-['Poppins'] font-bold mb-10 text-center">Personal Information</h2>
              ...
              <div className="flex items-start justify-center gap-12">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col">
                    <label className="text-black text-opacity-50 font-['Inter'] font-bold text-[16px] mb-2">Firstname</label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col">
                    <label className="text-black text-opacity-50 font-['Inter'] font-bold text-[16px] mb-2">Lastname</label>
                    <input
                      type="text"
              ...
              <div className="mt-10 flex flex-col items-start px-6">
                <label className="text-black text-opacity-50 font-['Inter'] font-bold text-[16px] mb-2">School</label>
                <input
                  type="text"
              ...
              <div className="mt-8 px-6">
                <label className="text-black text-opacity-50 font-['Inter'] font-bold text-[16px] mb-2">Email</label>
                <input
                  type="email"
